...
const JsIcon = ({ cursor, cardRef, mouseOnCard }: JsIconProps) => {
  ...
  return (
    <svg
      ...
      className="lucide lucide-wand-sparkles hover:cursor-pointer transition-all duration-200"
    >
      <defs>
        <radialGradient
          id="emeraldGradient"
      ...
      />
      <path stroke="url(#emeraldGradient)" d="m14 7 3 3" />
      <path stroke="url(#emeraldGradient)" d="M5 6v4" />
      <path stroke="url(#emeraldGradient)" d="M19 14v4" />
      <path stroke="url(#emeraldGradient)" d="M10 2v2" />
      <path stroke="url(#emeraldGradient)" d="M7 8H3" />
      <path stroke="url(#emeraldGradient)" d="M21 16h-4" />
      <path stroke="url(#emeraldGradient)" d="M11 3H9" />
    </svg>
  );
};
...

{
  /* <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 50 50"
        className="h-[200px] w-[200px] hover:cursor-pointer transition-all duration-200 absolute  hidden lg:flex -left-[40px] top-[150px] opacity-40 hover:opacity-60 -rotate-[22deg]  "
      >
        <defs>
          <radialGradient
            id="emeraldGradient"
