...
//   const { ref } = useSectionInView("Test");
...
//         >
//           <p className="text-4xl text-center font-medium bg-gradient-to-br from-white to-[#000000] bg-clip-text text-transparent  mb-10">
